...
```{r Exploration, ,echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
We can see that `Income Index` and `dddd` doesn't meet the **linearity assumption**, then we'll remove them.
